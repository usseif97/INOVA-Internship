...
class FragmentOneFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bt_increment.setOnClickListener { v: View? ->
            count++
            if (communicator != null) communicator!!.updateCount(count)
        }
    }
    ...
    override fun onViewStateRestored(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey("count")) count = savedInstanceState.getInt("count")
    }
