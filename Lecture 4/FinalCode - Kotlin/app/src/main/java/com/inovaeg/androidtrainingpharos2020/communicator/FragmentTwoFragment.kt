...
class FragmentTwoFragment : Fragment() {
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putString("textview", tv_count?.text.toString())
    }

    override fun onViewStateRestored(savedInstanceState: Bundle?) {
        super.onViewStateRestored(savedInstanceState)
        if (savedInstanceState != null && savedInstanceState.containsKey("textview")) tv_count?.text = savedInstanceState.getString("textview")
    }
